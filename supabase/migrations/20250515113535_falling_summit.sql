...
DROP POLICY IF EXISTS "Users can view their own subscription" ON pro_subscriptions;
DROP POLICY IF EXISTS "System can manage subscriptions" ON pro_subscriptions;
