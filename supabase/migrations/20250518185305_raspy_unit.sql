/*
  # Fix admin stats function and permissions

  1. Changes
    - Fix ambiguous column references by using table aliases
    - Add proper security context for admin access
    - Add admin role check to function
*/

-- Drop existing function
DROP FUNCTION IF EXISTS get_admin_stats(uuid, text);

-- Create new function with fixed column references and admin check
