/*
  # Fix analytics access and permissions

  1. Changes
    - Drop and recreate get_admin_stats function with proper column references
    - Update user table policies to fix permission issues
...
-- Create new function with fixed column references and proper error handling
CREATE OR REPLACE FUNCTION get_admin_stats(
  in_creator_id uuid,
  in_date_range text DEFAULT '30d'
)
RETURNS json
LANGUAGE plpgsql
SECURITY DEFINER
