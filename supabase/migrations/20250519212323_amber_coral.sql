/*
  ...
  1. Changes
    - Create simplified storage policies with proper folder structure
    - Fix RLS policies to allow uploads to user-specific folders
...
-- Allow authenticated users to upload to product-files bucket
