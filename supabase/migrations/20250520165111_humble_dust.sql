...
CREATE POLICY "profile_images_select_20250521"
ON storage.objects FOR SELECT
TO public
USING (bucket_id = 'profile-images');

-- Allow authenticated users to upload profile images
CREATE POLICY "profile_images_insert_20250521"
ON storage.objects FOR INSERT
TO authenticated
WITH CHECK (bucket_id = 'profile-images');

-- Allow authenticated users to update profile images
CREATE POLICY "profile_images_update_20250521"
...
CREATE POLICY "profile_images_delete_20250521"
