-- Create new storage buckets for artifacts with correct privacy settings
...
CREATE POLICY "artifact_snapshots_select_fix"
ON storage.objects FOR SELECT
TO public
USING (bucket_id = 'artifact-snapshots');

CREATE POLICY "artifact_snapshots_insert_fix"
ON storage.objects FOR INSERT
TO authenticated
WITH CHECK (bucket_id = 'artifact-snapshots');

CREATE POLICY "artifact_snapshots_update_fix"
ON storage.objects FOR UPDATE
TO authenticated
USING (bucket_id = 'artifact-snapshots')
WITH CHECK (bucket_id = 'artifact-snapshots');

CREATE POLICY "artifact_snapshots_delete_fix"
ON storage.objects FOR DELETE
TO authenticated
USING (bucket_id = 'artifact-snapshots');

-- Create simple policies for artifact-vault bucket (private)
CREATE POLICY "artifact_vault_select_fix"
ON storage.objects FOR SELECT
TO authenticated
USING (bucket_id = 'artifact-vault');

CREATE POLICY "artifact_vault_insert_fix"
ON storage.objects FOR INSERT
TO authenticated
WITH CHECK (bucket_id = 'artifact-vault');

CREATE POLICY "artifact_vault_update_fix"
ON storage.objects FOR UPDATE
TO authenticated
USING (bucket_id = 'artifact-vault')
WITH CHECK (bucket_id = 'artifact-vault');

CREATE POLICY "artifact_vault_delete_fix"
ON storage.objects FOR DELETE
TO authenticated
USING (bucket_id = 'artifact-vault');
...
CREATE POLICY "artifacts_select_public_fix"
ON artifacts FOR SELECT
TO public
USING (true);

CREATE POLICY "artifacts_manage_own_fix"
